...
//     public AdminController(UserService userService, LoanInterestRateService loanInterestRateService) {
...
//     // --- SYSTEM CONFIGURATION (LOAN RATES) ---
//     @GetMapping("/loan-types")
//     public String loanConfigPage(Model model) {
//         model.addAttribute("loanTypes", loanInterestRateService.getAllLoanTypes());
//         model.addAttribute("currentUri", "/admin/loan-types");
...
//     public String updateLoanType(@RequestParam Long id, @RequestParam Double rate, @RequestParam boolean active) {
//         loanInterestRateService.updateLoanType(id, rate, active);
//         return "redirect:/admin/loan-types";
//     }

//     @PostMapping("/loan-types/delete")
//     public String deleteLoanType(@RequestParam Long id) {
